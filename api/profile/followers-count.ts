// GET /api/profile/followers-count - Returns followers count for authenticated user
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.error("[profile/followers-count] Error:", error);
    return res
      .status(500)
      .json({ error: error.message || "Failed to get followers count" });
  }
}
