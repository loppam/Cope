      ...
      <button
        ...
        className={cn(
          ...
          'disabled:opacity-50 disabled:pointer-events-none',
          {
            ...
            'bg-accent-primary text-[#000000] hover:bg-accent-hover active:scale-[0.98]':
              variant === 'primary',
            // Secondary - Solid Surface
            'bg-surface-2 text-white border border-border hover:bg-surface-3 active:scale-[0.98]':
              variant === 'secondary',
            // Outline
            ...
            'text-text-secondary hover:text-white hover:bg-white/5 active:scale-[0.98]':
              variant === 'ghost',
            // Glass - Minimal
            'bg-white/5 text-white hover:bg-white/10 border border-white/5 active:scale-[0.98]':
              variant === 'glass',
            // Destructive
            'bg-error/10 text-error border border-error/20 hover:bg-error/20':
              variant === 'destructive',
            // Icon
            'p-0 hover:bg-white/5 rounded-full text-text-secondary hover:text-white': 
              variant === 'icon',
          },
          {
