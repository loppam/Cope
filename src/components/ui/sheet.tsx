    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 left-0 right-0 h-auto max-h-[90vh] rounded-t-2xl border-t border-white/10",
          className,
        )}
        {...props}
      >
